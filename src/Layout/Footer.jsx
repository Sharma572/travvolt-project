...
const Footer = () => {
  return (
   ...
   <Flex mt="20px">
   <Spacer/>
   <Box borderRadius="5px" textAlign="center" color="white" p='4'mr="10px" w="300px" h="40px" bg='#005778'>
    Report an Issue
   </Box>
  <Box borderRadius="5px" textAlign="center" color="white" p='4'mr="10px" w="300px" h="40px" bg='#005778'>
  Support
  ...
  <Box borderRadius="5px" textAlign="center" color="white" p='4' w="300px" h="40px" bg='#005778'>
    Online Assistance
  </Box>
  <Spacer/>
  </Flex>
   ...
   <div className='containetArticals2Div'>
         <div className='skdTravel' >
           ...
           <div className='copyRightFooter'>
             <h6>2022 TRAVVOLT &copy; All Rights Reserved</h6>
           </div>
         </div>
</div>
