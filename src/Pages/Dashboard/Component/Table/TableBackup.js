...
const Table = () => {
  ...
  return (
    <>
    <div className="table__container" style={{position: 'relative',left:'10%',width: '90%'}}>
      ...
      <div style={{width:'89%',zIndex:'1'}} className="flex-row justify-center">
               ...
               tableData.map((ele)=>{
                return(
                  ...
                  <tr>
                    ...
                    <td>{ele.agency_gst_details.agency_classification}</td>
