...
import { adminSingOut } from '../../../Redux/Auth/AdminSignOut/actionAdminSignOut';
...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar  sx={{position: 'fixed', left: 0 ,top: 0, zIndex:'100' ,flexGrow: 1,py:2}} position="static">
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
             ...
             <Button>
                        <Typography color='white' fontSize='15px' display='flex' justifyContent='center' alignItems='center' onClick={signOutAdmin}>
                            Log Out
                        </Typography>
                    </Button>
          </Box>
